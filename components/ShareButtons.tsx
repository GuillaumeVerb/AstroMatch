...
export default function ShareButtons({
  ...
  const instagramText = lang === 'fr'
    ? `✨ Compatibilité astrologique entre ${firstname1} & ${firstname2} : ${score}%\n\n🔮 Une relation avec un joli potentiel d'évolution.\n\nTeste ta compatibilité ici : ${shareUrl} 👇`
    : `✨ Astrological compatibility between ${firstname1} & ${firstname2} : ${score}%\n\n🔮 A relationship with nice evolution potential.\n\nTest your compatibility here: ${shareUrl} 👇`
    ...
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap justify-center gap-3">
        ...
        <button
          ...
          className="px-4 py-2 rounded-xl bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#FCB045]/20 border border-[#833AB4]/30 hover:opacity-80 transition backdrop-blur-sm flex items-center gap-2"
